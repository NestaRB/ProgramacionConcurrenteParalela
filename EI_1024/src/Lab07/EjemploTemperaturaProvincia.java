...
class EjemploTemperaturaProvincia {
    public static void main(String[] args) {
        ...
        System.out.println( "  Pueblo: " + MaxMinPar.damePueblo() + " , Maxima = " + MaxMinPar.dameTemperaturaMaxima() + " , Minima = " + MaxMinPar.dameTemperaturaMinima() );
            ...
            switch (opcion) {
                ...
                case 1:  // Gestion Propia
                    ...
                    for (int i = 0; i < numHebras; i++) {
                        trabajadores[i] = new HebraTrabajadora(cola, MaxMinPar, fecha);
    ...
    public static boolean ProcesaPuebloPar(String fecha, int codPueblo,
                                           PuebloMaximaMinimaPar MaxMin, boolean imprime) {
        URL url;
        InputStream is = null;
        BufferedReader br;
        String line, poblacion = new String(), provincia = new String();
...
class HebraTrabajadora extends Thread {
    ...
    HebraTrabajadora(BlockingQueue<TareaEnColaGestionPropia> cola, PuebloMaximaMinimaPar MaxMinPar, String fecha) {
        this.cola = cola;
    ...
    public void run() {
        ...
        while (true) {
            try {
                ...
                if (tarea.esVeneno) {
                    System.out.println("Hebra envenenada");
                    break;
                }

                EjemploTemperaturaProvincia.ProcesaPuebloPar(fecha, tarea.codPueblo, MaxMinPar, false);
